    ...
    const promptBase: ChatMessage[] = [
      {
        ...
        content:
          ...
          "Once you find a good tool, download it so you can call it to complete the task.\n" +
          "Now that you have it downloaded, review the criteria and needed fields. Search for the information in the fact memory before asking the user to provide anything.\n" +
          "If you need information to answer a question or call a tool, then search for it with the fact memory tool.\n" +
          "Only use the information needed to make the tool call, if it doesnt ask for it, it is not needed and you dont need to get it\n\n" +
          ...
          "Dont say you cannot do something before you have looked it up thoroughly in the registry."
      },
      ...history,
    ];
